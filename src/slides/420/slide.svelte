...
<TitleWithList title="The Workflow: Route-by-Route Validation" items={[{"text":"Different from #5361's batch processing"},{"text":"Visit each route in browser"},{"text":"Check against official shadcn-svelte docs"},{"text":"Verify tokens, contrast, dark mode"},{"text":"No 'good enough' - authentic or nothing"}]} />
