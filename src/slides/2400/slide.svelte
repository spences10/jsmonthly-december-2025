...
<!-- Use for: Embedding Bluesky posts in presentations -->
<!-- How to get the post_id:
     1. Go to your Bluesky post
     2. Click the dropdown menu (•••)
     3. Select "Embed Post"
     4. Copy the did:plc identifier (format: did:plc:xxxxx/app.bsky.feed.post/xxxxx)
